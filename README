...
a simple statistical profiler for Gambit.
...
This particular statistical profiler works by using Gambit's
...
See the file 'examples/example.scm' for a simple demo of how to use this libray.
